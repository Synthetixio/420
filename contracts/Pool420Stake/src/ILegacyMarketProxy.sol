...
interface ILegacyMarketProxy {
    ...
    event AccountMigrated(
        address indexed staker, uint256 indexed accountId, uint256 collateralAmount, uint256 debtAmount
    );
    ...
    function setSystemAddresses(address v2xResolverAddress, address v3SystemAddress, address snxDistributor)
        external
        returns (bool didInitialize);
