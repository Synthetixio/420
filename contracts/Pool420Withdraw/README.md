# Pool420Withdraw contract

Contract for Pool420 to close position and to withdraw collateral
...
forge create \
  ...
  --verify \
  src/Pool420Withdraw.sol:Pool420Withdraw \
  --constructor-args \
      $_CoreProxy \
      $_AccountProxy \
...
# Get the readable abi and update importPool420Withdraw.ts
node ../../readableAbi.js "$(cat ./out/Pool420Withdraw.sol/Pool420Withdraw.json | jq -c '.metadata.output.abi')"
```
